...
def generate_launch_description():
    ...
    declare_lidar_model_arg = DeclareLaunchArgument(
        "lidar_model",
        default_value="velodyne_puck",          #velodyne_puck   change this for vector machines demo
    ...
    world_file = PathJoinSubstitution([world_package, "worlds", "xyz.sdf"])    # xyz.sdf  change this for vector machines demo, husarion_world.sdf for rosbot demo
