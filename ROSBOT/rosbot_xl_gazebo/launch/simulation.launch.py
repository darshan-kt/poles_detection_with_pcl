...
def generate_launch_description():
    ...
    declare_lidar_model_arg = DeclareLaunchArgument(
        "lidar_model",
        default_value="slamtec_rplidar_s1",          #velodyne_puck   change this for vector machines demo
    ...
    world_file = PathJoinSubstitution([world_package, "worlds", "husarion_world.sdf"])    # xyz.sdf  change this for vector machines demo, husarion_world.sdf for rosbot demo
