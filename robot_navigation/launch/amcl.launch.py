...
def generate_launch_description():
    ...
    map_file_arg = DeclareLaunchArgument(
        "map_file",
        default_value=PathJoinSubstitution([FindPackageShare("robot_navigation"), 'maps', 'map.yaml']),
    ...
    amcl_params_file_arg = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [FindPackageShare("robot_navigation"), 'config', 'amcl_config.yaml']
        ),
    ...
    nav_manager = Node(
        ...
        parameters=[
            ...
            {"autostart": True},                                        #The life cycle manager node set TRUE to start automatically
